...
Warlockery is a Quilt mod for Minecraft 26.3, compiled against the shared Fabric API. Development runs and unit tests use Quilt Loader 0.30.1. This guide covers local setup, the project layout, common development tasks, testing, and release builds.
