...
Warlockery is a NeoForge mod for Minecraft 26.3. This guide covers local setup, the project layout, common development tasks, testing, and release builds.
...
.\gradlew.bat runGameTestServer --parallel --max-workers=24
.\gradlew.bat runData --parallel --max-workers=24
```
...
English in `assets/warlockery/lang/en_us.json` is the source language. French, Spanish, Brazilian Portuguese, German, Polish, Russian, Turkish, Japanese, Korean, Simplified Chinese, and Traditional Chinese for Taiwan use `fr_fr`, `es_es`, `pt_br`, `de_de`, `pl_pl`, `ru_ru`, `tr_tr`, `ja_jp`, `ko_kr`, `zh_cn`, and `zh_tw` files in the same directory.
