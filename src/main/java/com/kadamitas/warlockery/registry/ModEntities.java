...
public final class ModEntities {
    ...
    public static final RegistrationHandle<EntityType<HobgoblinEntity>> HOBGOBLIN = register("hobgoblin",
        () -> {
            ...
            return EntityType.Builder.of(HobgoblinEntity::new, MobCategory.CREATURE)
                ...
                .build(entityKey("hobgoblin"));
        });
    public static final RegistrationHandle<EntityType<GoblinEntity>> GOBLIN = register("goblin",
        () -> {
            ...
            return EntityType.Builder.of(GoblinEntity::new, MobCategory.MONSTER)
                .sized(visual.width(), visual.height())
                .notInPeaceful()
                .build(entityKey("goblin"));
        });
    public static final RegistrationHandle<EntityType<StonebrokerEntity>> STONEBROKER = register("stonebroker",
        () -> {
            ...
            return EntityType.Builder.of(StonebrokerEntity::new, MobCategory.MONSTER)
                .sized(visual.width(), visual.height())
                .notInPeaceful()
                .build(entityKey("stonebroker"));
        });
    public static final RegistrationHandle<EntityType<ForgewardenEntity>> FORGEWARDEN = register("forgewarden",
        () -> {
    ...
    private static void registerSpawnPlacements() {
        ...
        NATURAL_SPAWN_IDS.stream().filter(id -> !"hobgoblin".equals(id) && !"goblin".equals(id)).forEach(id -> {
