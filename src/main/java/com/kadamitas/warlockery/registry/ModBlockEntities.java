...
public final class ModBlockEntities {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<com.kadamitas.warlockery.block.entity.CircleHeartBlockEntity>> CIRCLE_HEART = REGISTRY.register(
        "circle_heart",
