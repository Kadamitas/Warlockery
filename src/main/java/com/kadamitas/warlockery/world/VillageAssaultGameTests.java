...
public final class VillageAssaultGameTests {
    ...
    public static void infectedVillagerTransformsAndRestoresWithIdentity(final GameTestHelper helper) {
        ...
        original.getPersistentData().putLong(VillageAssaultRuntime.BLOOD_DRAINED_UNTIL, bloodLockExpiry);
    ...
    public static void guardsRetaliateAgainstPlayersWithSilverBolts(final GameTestHelper helper) {
        ...
        helper.onEachTick(() -> {
            ...
            final LivingDamageEvent.Pre silverHit = new LivingDamageEvent.Pre(
                werewolf,
            ...
            helper.assertValueEqual(silverHit.getNewDamage(), 6.0F,
    ...
    public static void bloodDrainedTradeLockUsesForgeInteractionEvent(final GameTestHelper helper) {
        helper.setBlock(new BlockPos(1, 0, 1), Blocks.STONE);
        ...
        helper.assertTrue(VillageAssaultRuntime.handleVillagerInteraction(locked),
            "a blood-drained villager interaction must be consumed by the Forge hook");
        helper.assertValueEqual(locked.getCancellationResult(), InteractionResult.FAIL,
            "blood-drained villager interaction result");
        ...
        helper.assertTrue(!VillageAssaultRuntime.handleVillagerInteraction(expired),
    ...
    public static void onlyRaidContributorsReceiveSettlementRewards(final GameTestHelper helper) {
        ...
        final LivingDamageEvent.Pre contribution = new LivingDamageEvent.Pre(
            raider,
            new DamageContainer(level.damageSources().playerAttack(contributor), 2.0F)
        );
    ...
    public static void compactWavesPreserveCountsPowersAndSettlementVariants(final GameTestHelper helper) {
        ...
        for (final AssaultKind kind : AssaultKind.values()) {
            for (int wave = 1; wave <= VillageAssaultRules.WAVE_COUNT; wave++) {
                ...
                helper.assertTrue(members.stream().allMatch(entity -> entity.getPersistentData()
                ...
                helper.assertTrue(members.stream().allMatch(entity -> entity.getPersistentData().getIntOr(
                    VillageAssaultRuntime.ASSAULT_WAVE, 0
                ) == currentWave), "every compact wave member must retain its wave number");
                helper.assertValueEqual(members.stream().filter(entity -> entity.getPersistentData().getBooleanOr(
    ...
    public static void objectiveTargetingSkipsCompletedOrUnavailableResidents(final GameTestHelper helper) {
        ...
        drained.getPersistentData().putLong(
    ...
    public static void assaultObjectivesRewardsAndCleanupRemainIsolated(final GameTestHelper helper) {
        ...
        reloadedVictim.getPersistentData().merge(fedVictim.getPersistentData().copy());
        ...
        final LivingDamageEvent.Pre playerAttack = new LivingDamageEvent.Pre(
            defender, new DamageContainer(level.damageSources().mobAttack(werewolf), 4.0F)
        );
