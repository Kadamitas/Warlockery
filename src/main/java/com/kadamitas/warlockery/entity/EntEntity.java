...
public final class EntEntity extends PathfinderMob implements ArcaneCreature {
    ...
    public enum EntVariant{
        OAK("oak",0xFFFFFFFF,new EntTraits(200,15,.25,2)),BIRCH("birch",0xFFFFFFFF,new EntTraits(200,13,.29,1)),SPRUCE("spruce",0xFFFFFFFF,new EntTraits(200,16,.23,4)),JUNGLE("jungle",0xFFFFFFFF,new EntTraits(200,17,.27,2)),DARK_OAK("dark_oak",0xFFFFFFFF,new EntTraits(200,18,.21,6)),ACACIA("acacia",0xFFFFFFFF,new EntTraits(200,15,.30,1)),MANGROVE("mangrove",0xFFFFFFFF,new EntTraits(200,14,.22,5)),CHERRY("cherry",0xFFFFFFFF,new EntTraits(200,13,.28,1)),PALE_OAK("pale_oak",0xFFFFFFFF,new EntTraits(200,16,.24,3));
