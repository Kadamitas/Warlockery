...
public final class InfernalHierarchyEntity extends ArcaneMob {
    ...
    protected void readAdditionalSaveData(final ValueInput input) {
        ...
        input.read("ForgeData", CompoundTag.CODEC)
            .ifPresent(forgeData -> WarlockeryEntityData.get(this).merge(forgeData.copy()));
        final boolean legacyPhaseTriggered = WarlockeryEntityData.get(this)
            .getBooleanOr(LEGACY_PHASE_KEY, false);
        ...
        if (hierarchyState.phaseCompleted()) {
            WarlockeryEntityData.get(this).putBoolean(LEGACY_PHASE_KEY, true);
        }
        normalizeHierarchyIdentity();
    }
}
