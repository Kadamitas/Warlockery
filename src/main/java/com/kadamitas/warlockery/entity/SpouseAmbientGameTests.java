...
public final class SpouseAmbientGameTests {
    ...
    public static void spouseKissPersistsCooldown(final GameTestHelper helper) {
        ...
        helper.runAfterDelay(2, () -> {
            SpouseAmbientRuntime.tick(nami, helper.getLevel(), player);
            final long readyAt = WarlockeryEntityData.get(nami).getLongOr(SpouseAmbientRuntime.KISS_READY, 0L);
            ...
            helper.assertFalse(WarlockeryEntityData.get(nami).contains(SpouseAmbientRuntime.ACTION),
