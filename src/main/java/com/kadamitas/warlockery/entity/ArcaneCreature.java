...
public interface ArcaneCreature {
    ...
    enum CreatureKind {
        ...
        GOBLIN, HOBGOBLIN, THORNED_PURSUER, ILLUSION_CREEPER, ILLUSION_SPIDER,
        ILLUSION_ZOMBIE, IMP, EMBERHORN_ARCHFIEND, NAAMAH, ABYSSAL_REGENT, LOST_SOUL, LOUSE,
        ...
        public boolean isVampiric() {
            return this == VAMPIRE || this == NAAMAH || this == BLOOD_THRALL;
        }
