...
/** A unique, data-driven GameTest batch boundary which preserves its delegated environment. */
public record IsolatedTestEnvironment(
    ...
    public void teardown(
        ...
        // Vanilla places the next batch structure before tearing this environment down. Every
        // structure admitted by GameTestInstanceContractTest is entity-free, so no next-batch
        // entity exists yet; add a per-batch entity snapshot before admitting embedded entities.
