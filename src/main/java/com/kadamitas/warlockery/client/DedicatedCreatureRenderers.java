...
public final class DedicatedCreatureRenderers {
    ...
    public static void registerAll(final EntityRenderersEvent.RegisterRenderers event) {
        ...
        register(event, "circle_mage", CircleMageRenderer::new);
        ...
        register(event, "spirit", TranslucentSpiritRenderer::new);
        register(event, "stonebroker", StonebrokerRenderer::new);
