...
public final class WarlockeryGameTests {
    ...
    public static void selfAppliedDollRemainsActiveOnShelf(final GameTestHelper helper) {
        ...
        DollItem.handleDamage(event);
        helper.assertValueEqual(event.getAmount(), 0.0F, "a shelved death guard must prevent lethal damage");
    ...
    private static void removeTestAltarAtEnd(final GameTestHelper helper, final BlockPos relativeAltar) {
        com.kadamitas.warlockery.util.GameTestCleanup.add(helper, passed -> {
    ...
    public static void pipeAutomationUsesSidedItemHandlers(final GameTestHelper helper) {
        ...
        withPoweredAltar(helper, altarRelative, 180, altar -> {
            ...
            helper.assertValueEqual(
                powerBefore - powerSources.stream().mapToInt(AltarBlockEntity::availablePower).sum(), 180,
