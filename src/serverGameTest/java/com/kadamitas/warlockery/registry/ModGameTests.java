...
public final class ModGameTests {
    ...
    static {
        ...
        REGISTRY.register("vine_native_attachment_spread_and_support",
            () -> com.kadamitas.warlockery.block.LegacyPlantGameTests::vineNativeAttachmentSpreadAndSupportRemoval);
        REGISTRY.register("placed_mirrors_travel_to_exact_nearest_usable_partner",
            () -> com.kadamitas.warlockery.block.PlacedMirrorGameTests::crouchUseArrivesAtNearestUsablePlacedMirror);
        REGISTRY.register("doll_lethal_protection_and_mending_respect_dream_boundary",
            () -> com.kadamitas.warlockery.dream.DollSpiritBoundaryGameTests::lethalProtectionAndMendingStayOnTheirOwnSide);
        REGISTRY.register("dolls_keep_realm_across_shelves_saving_and_waking",
            () -> com.kadamitas.warlockery.dream.DollSpiritBoundaryGameTests::craftedDollsKeepTheirRealmAcrossShelvesSavingAndWaking);
        REGISTRY.register("doll_remote_actions_cannot_cross_dream",
            () -> com.kadamitas.warlockery.dream.DollSpiritBoundaryGameTests::remoteDollHexesAndDamageLinksCannotCrossTheDream);
        REGISTRY.register("overworld_magnet_respects_ritual_offerings",
            () -> com.kadamitas.warlockery.magic.MagicPathOfferingGameTests::passiveMagnetPreservesOfferingsAndResumesAfterHeartRemoval);
        ...
        REGISTRY.register("ritual_severance_consumes_one_ring_on_success",
            () -> RitualOutcomeGameTests::severanceConsumesOneRingOnlyWhenAMarriageEnds);
        REGISTRY.register("ritual_graveyard_mist_restores_undead_health",
            () -> RitualOutcomeGameTests::graveyardMistRestoresUndeadHealthThroughNormalEffectTicks);
        ...
        REGISTRY.register("blood_drained_trade_lock_uses_fabric_interaction_callback",
            () -> VillageAssaultGameTests::bloodDrainedTradeLockUsesFabricInteractionCallback);
        ...
        REGISTRY.register("spirit_world_body_equipment_returns_on_wake",
            () -> SpiritWorldGameTests::dispenserOfferedBodyEquipmentReturnsOnWake);
        REGISTRY.register("spirit_world_body_equipment_drops_once_on_death",
            () -> SpiritWorldGameTests::dispenserOfferedBodyEquipmentDropsOnceOnDeath);
        REGISTRY.register("spirit_world_creative_entry_remains_body_exempt",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::creativeEntryRemainsBodyExemptAfterGameModeChange);
        REGISTRY.register("spirit_world_bound_entry_preserves_source_and_arrival",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::boundEntryKeepsItsExactSourceAndRequestedArrival);
        REGISTRY.register("spirit_world_manifestation_preserves_body_and_inventory_boundary",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::manifestationKeepsOneBodyAndSeparatesBoundaryInventories);
        REGISTRY.register("spirit_world_canceled_external_transfer_rolls_back",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::canceledExternalTransferRestoresBodyPortalAndInventory);
        REGISTRY.register("spirit_portal_crafted_frames_connect_in_both_axes",
            () -> com.kadamitas.warlockery.block.SpiritPortalBlockGameTests::craftedFramesConnectInBothAxes);
        REGISTRY.register("spirit_portal_generated_return_column_joins_vertically",
            () -> com.kadamitas.warlockery.block.SpiritPortalBlockGameTests::generatedReturnColumnJoinsVertically);
        REGISTRY.register("spirit_world_canceled_external_exit_restores_inventory",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::canceledExternalExitRestoresTheDreamInventory);
        REGISTRY.register("spirit_world_generic_native_transfer_keeps_body_and_inventory",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::genericNativeTeleportLeavesBodyAtSource);
        REGISTRY.register("spirit_world_settles_menu_items_before_snapshots",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::menuContentsSettleBeforeSpiritInventorySnapshots);
        REGISTRY.register("spirit_world_canceled_manifestation_return_restores_menus",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::canceledManifestationReturnRestoresSettledMenus);
        REGISTRY.register("spirit_world_native_manifestation_return_filters_menu_acquisitions",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::nativeManifestationReturnFiltersPhysicalMenuAcquisitions);
        REGISTRY.register("spirit_world_canceled_boundary_does_not_replay_spent_items",
            () -> com.kadamitas.warlockery.dream.SpiritWorldGameTests::canceledBoundaryDoesNotReplayDroppedOrConsumedItems);
