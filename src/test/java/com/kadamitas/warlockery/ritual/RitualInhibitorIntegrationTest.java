...
final class RitualInhibitorIntegrationTest {
    ...
    void voidBrambleSuppressionFeedsTheOrdinaryRitualDiagnostic() {
        assertEquals(0, RitualManager.ritualInhibitorCount(0, false, false));
        assertEquals(1, RitualManager.ritualInhibitorCount(0, true, false));
        assertEquals(3, RitualManager.ritualInhibitorCount(2, true, false));
