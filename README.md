...
Warlockery 1.5.2-LlaGuiT0-26.2.0.45 is a supporter compatibility build for Minecraft 26.2, Java 25, and NeoForge 26.2.0.45-beta exactly.
...
Normal 1.5.2 releases target Forge 65.1.2, NeoForge 26.2.0.64, and Fabric Loader 0.19.3 with Fabric API 0.158.0+26.2. This `1.5.2-LlaGuiT0-26.2.0.45` supporter build remains NeoForge-only and requires NeoForge `[26.2.0.45-beta,26.2.0.46-beta)`.
