...
Warlockery 1.5.3 is a standalone ritual magic mod by Kadamitas for Minecraft 26.2, Java 25, and Forge 65.1.2.
...
1. Install Minecraft 26.2 with Java 25 and Forge 65.1.2 or newer.
...
Normal 1.5.3 releases target Forge 65.1.2, NeoForge 26.2.0.64, and Fabric Loader 0.19.3 with Fabric API 0.158.0+26.2. The `1.5.3-LlaGuiT0-26.2.0.45` supporter build remains NeoForge-only and requires NeoForge `[26.2.0.45-beta,26.2.0.46-beta)`.
